...
namespace Completed
{
	...
	public class GameManager : MonoBehaviour
	{
        ...
        private void Restart()
        {
            ...
            lh.GetComponent<LevelHelper>().enemySpawnRate = 10;
            lh.GetComponent<LevelHelper>().foodSpawnRate = 10;
            lh.GetComponent<LevelHelper>().currentLevel = 0;
            lh.GetComponent<LevelHelper>().numRooms = 2;
